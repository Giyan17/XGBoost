...
accuracy_XGBoost = (cm_XGBoost[0][0] + cm_XGBoost[1][1]) / (cm_XGBoost[0][0] + cm_XGBoost[1][1] + cm_XGBoost[0][1] + cm_XGBoost[1][0])
...
print(cm_logistic)
accuracy_logistic = (cm_logistic[0][0] + cm_logistic[1][1]) / (cm_logistic[0][0] + cm_logistic[1][1] + cm_logistic[0][1] + cm_logistic[1][0])
...
accuracy_randomforest = (cm_RandomForest[0][0] + cm_RandomForest[1][1]) / (cm_RandomForest[0][0] + cm_RandomForest[1][1] + cm_RandomForest[0][1] + cm_RandomForest[1][0])
# Visualising the Training set results
from matplotlib.colors import ListedColormap
X_set, y_set = X_train, y_train
X1, X2 = np.meshgrid(np.arange(start = X_set[:, 0].min() - 1, stop = X_set[:, 0].max() + 1, step = 0.01),
